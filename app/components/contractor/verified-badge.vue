 ...
 * Displays a verification badge for claimed contractor profiles
 */
</script>
...
<template>
  <div class="inline-flex items-center justify-center gap-1.5">
    <svg
      class="h-5 w-5 text-[#03a71e]"
      viewBox="0 0 22 22"
      fill="currentColor"
      aria-hidden="true"
    >
      <!-- Starburst verification badge -->
    ...
    <span class="text-base font-medium text-[#03a71e]">Verified Contractor</span>
  </div>
</template>
